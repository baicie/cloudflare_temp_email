export const deMessages = {
  ...
  "views.admin.CreateAccount.batchBaseName": "Namenspräfix",
  "views.admin.CreateAccount.batchBaseNamePlaceholder": "Zum Beispiel: batch",
  "views.admin.CreateAccount.batchCount": "Anzahl",
  "views.admin.CreateAccount.batchMode": "Stapel",
  "views.admin.CreateAccount.batchPartialSuccess": "{created} erstellt; {failed} fehlgeschlagen",
  "views.admin.CreateAccount.batchPreview": "Adressbereich",
  "views.admin.CreateAccount.batchStartNumber": "Startnummer",
  "views.admin.CreateAccount.batchSuccess": "{count} Adressen erstellt",
  "views.admin.CreateAccount.createBatch": "Adressen erstellen",
  "views.admin.CreateAccount.createMode": "Erstellungsmodus",
  "views.admin.CreateAccount.invalidBatch": "Gültiges Präfix, Startnummer, Anzahl und Domain eingeben",
  "views.admin.CreateAccount.singleMode": "Einzeln",
  "components.BatchAddressResultModal.address": "Adresse",
  "components.BatchAddressResultModal.copyCsv": "CSV kopieren",
  "components.BatchAddressResultModal.copyFailed": "Kopieren fehlgeschlagen",
  "components.BatchAddressResultModal.copySuccess": "Kopiert",
  "components.BatchAddressResultModal.created": "{count} erstellt",
  "components.BatchAddressResultModal.credential": "Address JWT",
  "components.BatchAddressResultModal.downloadCsv": "CSV herunterladen",
  "components.BatchAddressResultModal.failed": "{count} fehlgeschlagen",
  "components.BatchAddressResultModal.failureDetails": "Fehlerdetails",
  "components.BatchAddressResultModal.securityTip": "Die exportierte Datei enthält Postfach-Zugangsdaten. Bewahren Sie sie sicher auf.",
  "components.BatchAddressResultModal.title": "Ergebnisse der Stapelerstellung"
}
