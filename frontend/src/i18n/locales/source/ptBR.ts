export const ptBRMessages = {
  ...
  "views.admin.CreateAccount.batchBaseName": "Prefixo do nome",
  "views.admin.CreateAccount.batchBaseNamePlaceholder": "Por exemplo: batch",
  "views.admin.CreateAccount.batchCount": "Quantidade",
  "views.admin.CreateAccount.batchMode": "Em lote",
  "views.admin.CreateAccount.batchPartialSuccess": "{created} criados; {failed} falharam",
  "views.admin.CreateAccount.batchPreview": "Intervalo de endereços",
  "views.admin.CreateAccount.batchStartNumber": "Número inicial",
  "views.admin.CreateAccount.batchSuccess": "{count} endereços criados",
  "views.admin.CreateAccount.createBatch": "Criar endereços",
  "views.admin.CreateAccount.createMode": "Modo de criação",
  "views.admin.CreateAccount.invalidBatch": "Informe um prefixo, número inicial, quantidade e domínio válidos",
  "views.admin.CreateAccount.singleMode": "Individual",
  "components.BatchAddressResultModal.address": "Endereço",
  "components.BatchAddressResultModal.copyCsv": "Copiar CSV",
  "components.BatchAddressResultModal.copyFailed": "Falha ao copiar",
  "components.BatchAddressResultModal.copySuccess": "Copiado",
  "components.BatchAddressResultModal.created": "{count} criados",
  "components.BatchAddressResultModal.credential": "Address JWT",
  "components.BatchAddressResultModal.downloadCsv": "Baixar CSV",
  "components.BatchAddressResultModal.failed": "{count} falharam",
  "components.BatchAddressResultModal.failureDetails": "Detalhes das falhas",
  "components.BatchAddressResultModal.securityTip": "O arquivo exportado contém credenciais das caixas de correio. Armazene-o com segurança.",
  "components.BatchAddressResultModal.title": "Resultados da criação em lote"
}
