export const esMessages = {
  ...
  "views.admin.CreateAccount.batchBaseName": "Prefijo del nombre",
  "views.admin.CreateAccount.batchBaseNamePlaceholder": "Por ejemplo: batch",
  "views.admin.CreateAccount.batchCount": "Cantidad",
  "views.admin.CreateAccount.batchMode": "Por lotes",
  "views.admin.CreateAccount.batchPartialSuccess": "Creados {created}; {failed} fallidos",
  "views.admin.CreateAccount.batchPreview": "Rango de direcciones",
  "views.admin.CreateAccount.batchStartNumber": "Número inicial",
  "views.admin.CreateAccount.batchSuccess": "Se crearon {count} direcciones",
  "views.admin.CreateAccount.createBatch": "Crear direcciones",
  "views.admin.CreateAccount.createMode": "Modo de creación",
  "views.admin.CreateAccount.invalidBatch": "Introduce un prefijo, número inicial, cantidad y dominio válidos",
  "views.admin.CreateAccount.singleMode": "Individual",
  "components.BatchAddressResultModal.address": "Dirección",
  "components.BatchAddressResultModal.copyCsv": "Copiar CSV",
  "components.BatchAddressResultModal.copyFailed": "Error al copiar",
  "components.BatchAddressResultModal.copySuccess": "Copiado",
  "components.BatchAddressResultModal.created": "{count} creados",
  "components.BatchAddressResultModal.credential": "Address JWT",
  "components.BatchAddressResultModal.downloadCsv": "Descargar CSV",
  "components.BatchAddressResultModal.failed": "{count} fallidos",
  "components.BatchAddressResultModal.failureDetails": "Detalles de errores",
  "components.BatchAddressResultModal.securityTip": "El archivo exportado contiene credenciales de buzón. Guárdalo de forma segura.",
  "components.BatchAddressResultModal.title": "Resultados de creación por lotes"
}
