export const jaMessages = {
  ...
  "views.admin.CreateAccount.batchBaseName": "アドレス名のプレフィックス",
  "views.admin.CreateAccount.batchBaseNamePlaceholder": "例: batch",
  "views.admin.CreateAccount.batchCount": "作成数",
  "views.admin.CreateAccount.batchMode": "一括作成",
  "views.admin.CreateAccount.batchPartialSuccess": "{created} 件成功、{failed} 件失敗",
  "views.admin.CreateAccount.batchPreview": "アドレス範囲",
  "views.admin.CreateAccount.batchStartNumber": "開始番号",
  "views.admin.CreateAccount.batchSuccess": "{count} 件のアドレスを作成しました",
  "views.admin.CreateAccount.createBatch": "アドレスを一括作成",
  "views.admin.CreateAccount.createMode": "作成モード",
  "views.admin.CreateAccount.invalidBatch": "有効なプレフィックス、開始番号、作成数、ドメインを入力してください",
  "views.admin.CreateAccount.singleMode": "個別作成",
  "components.BatchAddressResultModal.address": "アドレス",
  "components.BatchAddressResultModal.copyCsv": "CSV をコピー",
  "components.BatchAddressResultModal.copyFailed": "コピーに失敗しました",
  "components.BatchAddressResultModal.copySuccess": "コピーしました",
  "components.BatchAddressResultModal.created": "{count} 件成功",
  "components.BatchAddressResultModal.credential": "Address JWT",
  "components.BatchAddressResultModal.downloadCsv": "CSV をダウンロード",
  "components.BatchAddressResultModal.failed": "{count} 件失敗",
  "components.BatchAddressResultModal.failureDetails": "失敗の詳細",
  "components.BatchAddressResultModal.securityTip": "エクスポートファイルにはメールボックスの認証情報が含まれます。安全に保管してください。",
  "components.BatchAddressResultModal.title": "一括作成結果"
}
